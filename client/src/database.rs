use crate::{chat::ChatState, platform::get_database};
use bevy::prelude::*;
...
pub fn init_db(db: Res<Database>, mut chat: ResMut<ChatState>) {
    ...
    chat.print(&format!("Database content table names{}", out));
}
